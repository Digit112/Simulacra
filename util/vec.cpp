...
vecd2 vecd2::lerp(vecd2 a, vecd2 b, float t) {
	return vecd2((b.x-a.x)*t+a.x, (b.y-a.y)*t+a.y);
}

vecd2 vecd2::bez3(vecd2 s, vecd2 c, vecd2 d, float t) {
...
vecd3 vecd3::lerp(vecd3 a, vecd3 b, float t) {
	return vecd3((b.x-a.x)*t+a.x, (b.y-a.y)*t+a.y, (b.z-a.z)*t+a.z);
}

vecd3 vecd3::bez3(vecd3 s, vecd3 c, vecd3 d, float t) {
	return lerp(lerp(s, c, t), lerp(c, d, t), t);
}
...
vecd4 vecd4::lerp(vecd4 a, vecd4 b, float t) {
	return vecd4((b.w-a.w)*t+a.w, (b.x-a.x)*t+a.x, (b.y-a.y)*t+a.y, (b.z-a.z)*t+a.z);
}

vecd4 vecd4::bez3(vecd4 s, vecd4 c, vecd4 d, float t) {
	return lerp(lerp(s, c, t), lerp(c, d, t), t);
}
...
quaternion quaternion::bez3(const quaternion& s, const quaternion& c, const quaternion& d, float t) {
	return slerp(slerp(s, c, t), slerp(c, d, t), t);
}
